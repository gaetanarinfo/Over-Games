    ...
    if (!pass.match(regex)) {
        ...
        if (document.getElementById('pseudoA').value === document.getElementById('pseudoVerif').value) {
            ...
            jQuery.ajax({
                ...
                data: { nom: $("#nomA").val(), prenom: $("#prenomA").val(), email: $("#emailA").val(), pseudo: $("#pseudoA").val(), password: $("#passwordA").val(), adresse: $("#adresseA").val(), adresse2: $("#adresse2A").val(), ville: $("#villeA").val(), pays: $("#paysA").val(), postalCode: $("#postalCodeA").val() },
                type: "POST",
                success: function(data) {
