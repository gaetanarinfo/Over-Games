...
function checkForumComment(event) {
    ...
    const div_result = document.getElementById('div-result-fo'),
...
function btn_resolved(forum_id, forum_id_cat, forum_id_cat_sujet) {
    ...
    const div_result = document.getElementById('div-result-resolved');
...
function btn_del_suj(id, id2, id3) {
    ...
    const div_result = document.getElementById('div-result-delete-suj');
