        ...
        1: function(t, e, i) {
            ...
            (r.VantaBase = class {
                ...
                prepareEl() {
                    ...
                    for (t = 0; t < this.el.children.length; t++)(e = this.el.children[t]), "static" === getComputedStyle(e).position && (e.style.position = "relative") && (e.style.top = "25%"), "auto" === getComputedStyle(e).zIndex && (e.style.zIndex = 1);
