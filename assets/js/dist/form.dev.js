...
function validateDate(date) {
  ...
  if (18 <= age && age <= 80) return true;else {
    return false;
  }
} //
...
function checkForm(event) {
  ...
  var checkBox = document.getElementById('checkBoxConfirm');
  var div_result = document.querySelector('.div-result');
  var avatar = document.querySelector("#file");
  var age = document.querySelector("#ageA");
  ...
  if (!pass.match(regex)) {
    ...
    var pseudo = document.getElementById('pseudoA').value;
    var pseudo2 = document.getElementById('pseudoVerif').value;
    var email = document.getElementById('emailA').value;
    var email2 = document.getElementById('emailVerif').value;
