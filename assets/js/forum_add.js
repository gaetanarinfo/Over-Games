function checkFormCat(event) {
    ...
    const div_result = document.getElementById('div-result-forum'),
    ...
    if (icone.value.length == 0) {
        ...
        jQuery.ajax({
            ...
            data: { icone: $("#iconefoA").val(), titre: $("#titrefoA").val(), content: $("#contentfoA").val(), titre2: $("#titre2foA").val(), rang: $("#rangfoA").val(), content2: $("#content2foA").val(), topic: $("#topicfoA").val() },
            type: "POST",
...
function checkFormSujet(event) {
    ...
    if (titre.value.length == 0) {
        ...
        jQuery.ajax({
            ...
            data: { cat: $("#catfoA").val(), titre: $("#titrefoA2").val(), content: $("#contentfoA2").val(), forum_id: $("#forum_idfoA").val(), forum_id_cat: $("#forum_id_catfoA").val(), forum_id_cat_sujet: $("#forum_id_cat_sujetfoA").val() },
            type: "POST",
            success: function(data) {
...
function checkFormSubCat(event) {
    ...
    const div_result = document.getElementById('div-result-forum-subcat'),
    ...
    if (titre.value.length == 0) {
        ...
        jQuery.ajax({
            ...
            data: { titre: $("#titrefoB").val(), titre2: $("#titrefoB2").val(), content: $("#contentfoB").val(), id: $("#forum_idfoB").val(), id2: $("#forum_id_catfoB").val() },
            type: "POST",
            success: function(data) {
...
function btn_del_cat(event) {
    ...
    const div_result = document.getElementById('div-result-delete');
...
function btn_del_top(event) {
    ...
    const div_result = document.getElementById('div-result-delete-top');
...
function checkFormSujet2() {
    ...
    const div_result = document.getElementById('div-result-edit');
...
function checkFormSubCat2() {
    ...
    const div_result = document.getElementById('div-result-forum-subcat2');
